      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {finished ? (
          <div className="card text-center">
            ...
            <div className="mt-6 p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 border border-amber-200 dark:border-amber-800">
              <p className="text-sm text-[#854F0B] dark:text-amber-300 mb-2">
                💡 想解锁更多？升级会员即可获取 <strong>80 例心律失常病例</strong> + <strong>无限次测验</strong>
              </p>
              <Link href={ROUTES.UPGRADE} className="text-sm font-medium text-amber-600 dark:text-amber-400 hover:underline">
                查看会员方案 →
              </Link>
            </div>
          </div>
          ...
          <>
            <div className="flex items-center gap-2 mb-6">
              ...
              <div className="flex-1 h-2 bg-[#E8ECF0] dark:bg-slate-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-[#2D8C6A] dark:bg-emerald-600 rounded-full transition-all"
